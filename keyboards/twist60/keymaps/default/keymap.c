...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
		...
		KC_LCTL, KC_LGUI,          KC_LALT,                   KC_SPC,                             TD(L12), KC_LEFT,	         KC_DOWN, KC_RGHT),

	[2] = LAYOUT(
		KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,           KC_DEL,
		DEBUG,            OUT_AUTO,OUT_USB, OUT_BT, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, RESET,
