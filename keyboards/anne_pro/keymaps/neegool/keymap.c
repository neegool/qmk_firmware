...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPACE,                  TD(L12), ALT_L,	                  GUI_D,   CTL_R
  ),
  [1] = LAYOUT(
  ...
  [2] = LAYOUT(
      ...
      DEBUG,   APL_RGB, APL_MOD, APL_RAT, APL_BRT, _______, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, RESET,
      KC_CALC, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, KC_INS,  KC_HOME, KC_PGUP,          _______,
      _______, KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT, TG(3),   _______, _______, KC_DEL,  KC_END,  KC_PGDN,           KC_UP,
      _______, _______, _______,                   _______,                                     _______, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [3] = LAYOUT(
